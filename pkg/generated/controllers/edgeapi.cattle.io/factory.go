...
import (
	...
	informers "github.com/cnrancher/edge-api-server/pkg/generated/informers/externalversions"
...
func (c *Factory) Edgeapi() Interface {
	return New(c.controllerManager, c.informerFactory.Edgeapi(), c.clientset)
}
